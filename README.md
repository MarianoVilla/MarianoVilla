...
- **Dive Into Design Patterns** - *A modern, practical take on patterns; got it from the mythical [refactoring.guru](https://refactoring.guru/design-patterns) and can't recommend it enough. It also has a solid intro to OOP.*
...
- **Git Internals** - *Understanding Git's belly made me stop treating it like a "save game" button. This is one of the books I also recommend in my [Git In C# project](https://github.com/MarianoVilla/Git-From-Scratch).*
...
- **Concrete Problems in AI Safety** - *Another hard recommend on AI safety. Robert Miles has [a series of videos](https://www.youtube.com/watch?v=lqJUIqZNzP8&list=PLqL14ZxTTA4fEp5ltiNinNHdkPuLK4778) about this paper that's also worth a watch.*
